...
// Согласовано со списком категорий услуг (см. миграцию CategoriesReset) —
// "Другое" здесь не дублируем: под него уже есть отдельное поле "Иное".
const INTERESTS = [
  "Рыбалка",
  "Охота",
  "Походы и треккинг",
